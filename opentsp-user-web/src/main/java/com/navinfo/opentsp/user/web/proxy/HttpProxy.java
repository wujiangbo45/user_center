...
public class HttpProxy {
    ...
    private final boolean doForwardIP = true;
    /**
     * User agents shouldn't send the url fragment but what if it does?
     */
    private final boolean doSendUrlFragment = true;

    private final CloseableHttpAsyncClient proxyClient;

    public HttpProxy() {
        final int maxConnections = 10000;
        proxyClient = HttpAsyncClients.custom()
    ...
    void service(HttpProxyContext proxyContext) throws ServletException, IOException {
        ...
        try {
            ...
            Future<HttpResponse> future = proxyClient.execute(proxyContext.getTargetHost(), proxyRequest, null);
            proxyResponse = future.get();
